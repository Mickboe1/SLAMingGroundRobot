...
*/
  ...
  /**
  * @brief Calculate the yaw of a quaternion
  * @param quaternion The quaternion
  * @return Yaw angle of quaternion
  */
  double yawOfQuaternion(const geometry_msgs::Quaternion& quaternion){
      tf::Matrix3x3 matrix(tf::Quaternion(quaternion.x, quaternion.y, quaternion.z, quaternion.w));
